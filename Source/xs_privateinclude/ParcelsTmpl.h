#if !defined(__PARCELSTMPL_H)
#define __PARCELSTMPL_H
...
// Class : Parcels
template<class T>
class ParcelsTmpl : public ObjectTmpl<T>, public IIdentifiable<String>
{
...
public:
	// Constructors
    ParcelsTmpl<T> (DocumentImpl* pDoc);
...
public:
	// Collections
    virtual ParcelCollection& Parcel();
    virtual const ParcelCollection& Parcel() const;
